/**************************************************************************************
  ...
  II    N    NN     N    NN      OOOO      SSSSS     EEEEE    N    NN       T
                         copyright (c) 2018, InnoSenT GmbH
                                 all rights reserved

***************************************************************************************

    filename:			main.cpp
    brief:				ethernetAPI example project - reading targetlist from iSYS-5020
    creation:			08.05.2018
    author:				Johannes Witzgall
...
int main(void)
{
	...
	/* set IP address and UDP port with iSYS-5020 delivery setting */
	uint8_t ipPart1 = 192;
	uint8_t ipPart2 = 168;
	uint8_t ipPart3 = 60;
	uint8_t ipPart4 = 20;
