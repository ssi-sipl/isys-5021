...
***************************************************************************************
    ...
    filename:			ehternet_API_basicTypes.h
    brief:				guidelines for data types used in ethernetAPI
    creation:			24.01.2017
...
#ifndef INCLUSION_GUARDS_ETHERNET_API_BASICTYPES
#define INCLUSION_GUARDS_ETHERNET_API_BASICTYPES
...
#endif /* INCLUSION_GUARDS_ETHERNET_API_BASICTYPES */
